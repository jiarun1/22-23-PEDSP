...
\label{mpu__armv8_8h_source}\index{C:/Users/ljr05/OneDrive -\/ The University of Nottingham/Desktop/University/Year 3/Y3 Semestar1/PEDSP (EEE2046)/Electronics Project/Codes/LCD1602\_Test\_Code/Drivers/CMSIS/Include/mpu\_armv8.h@{C:/Users/ljr05/OneDrive -\/ The University of Nottingham/Desktop/University/Year 3/Y3 Semestar1/PEDSP (EEE2046)/Electronics Project/Codes/LCD1602\_Test\_Code/Drivers/CMSIS/Include/mpu\_armv8.h}}
...
\DoxyCodeLine{126     }
\DoxyCodeLine{130 \mbox{\hyperlink{cmsis__armcc_8h_aba87361bfad2ae52cfe2f40c1a1dbf9c}{\_\_STATIC\_INLINE}} \textcolor{keywordtype}{void} \mbox{\hyperlink{mpu__armv8_8h_a5a3f40314553baccdeea551f86d9a997}{ARM\_MPU\_Enable}}(uint32\_t MPU\_Control)}
\DoxyCodeLine{131 \{}
...
\DoxyCodeLine{138 \}}
\DoxyCodeLine{139 }
\DoxyCodeLine{142 \mbox{\hyperlink{cmsis__armcc_8h_aba87361bfad2ae52cfe2f40c1a1dbf9c}{\_\_STATIC\_INLINE}} \textcolor{keywordtype}{void} \mbox{\hyperlink{mpu__armv8_8h_a61814eba4652a0fdfb76bbe222086327}{ARM\_MPU\_Disable}}(\textcolor{keywordtype}{void})}
\DoxyCodeLine{143 \{}
...
\DoxyCodeLine{155 \mbox{\hyperlink{cmsis__armcc_8h_aba87361bfad2ae52cfe2f40c1a1dbf9c}{\_\_STATIC\_INLINE}} \textcolor{keywordtype}{void} ARM\_MPU\_Enable\_NS(uint32\_t MPU\_Control)}
\DoxyCodeLine{156 \{}
...
\DoxyCodeLine{163 \}}
\DoxyCodeLine{164 }
\DoxyCodeLine{167 \mbox{\hyperlink{cmsis__armcc_8h_aba87361bfad2ae52cfe2f40c1a1dbf9c}{\_\_STATIC\_INLINE}} \textcolor{keywordtype}{void} ARM\_MPU\_Disable\_NS(\textcolor{keywordtype}{void})}
\DoxyCodeLine{168 \{}
...
\DoxyCodeLine{176 }
\DoxyCodeLine{182 \mbox{\hyperlink{cmsis__armcc_8h_aba87361bfad2ae52cfe2f40c1a1dbf9c}{\_\_STATIC\_INLINE}} \textcolor{keywordtype}{void} \mbox{\hyperlink{mpu__armv8_8h_a1799413f08a157d636a1491371c15ce2}{ARM\_MPU\_SetMemAttrEx}}(MPU\_Type* mpu, uint8\_t idx, uint8\_t attr)}
\DoxyCodeLine{183 \{}
...
\DoxyCodeLine{193 \}}
\DoxyCodeLine{194 }
\DoxyCodeLine{199 \mbox{\hyperlink{cmsis__armcc_8h_aba87361bfad2ae52cfe2f40c1a1dbf9c}{\_\_STATIC\_INLINE}} \textcolor{keywordtype}{void} \mbox{\hyperlink{mpu__armv8_8h_ab5b3c0a53d19c09a5550f1d9071ae65c}{ARM\_MPU\_SetMemAttr}}(uint8\_t idx, uint8\_t attr)}
\DoxyCodeLine{200 \{}
\DoxyCodeLine{201   \mbox{\hyperlink{mpu__armv8_8h_a1799413f08a157d636a1491371c15ce2}{ARM\_MPU\_SetMemAttrEx}}(MPU, idx, attr);}
\DoxyCodeLine{202 \}}
\DoxyCodeLine{203 }
\DoxyCodeLine{204 \textcolor{preprocessor}{\#ifdef MPU\_NS}}
\DoxyCodeLine{209 \mbox{\hyperlink{cmsis__armcc_8h_aba87361bfad2ae52cfe2f40c1a1dbf9c}{\_\_STATIC\_INLINE}} \textcolor{keywordtype}{void} ARM\_MPU\_SetMemAttr\_NS(uint8\_t idx, uint8\_t attr)}
\DoxyCodeLine{210 \{}
\DoxyCodeLine{211   \mbox{\hyperlink{mpu__armv8_8h_a1799413f08a157d636a1491371c15ce2}{ARM\_MPU\_SetMemAttrEx}}(MPU\_NS, idx, attr);}
\DoxyCodeLine{212 \}}
\DoxyCodeLine{213 \textcolor{preprocessor}{\#endif}}
\DoxyCodeLine{214 }
\DoxyCodeLine{219 \mbox{\hyperlink{cmsis__armcc_8h_aba87361bfad2ae52cfe2f40c1a1dbf9c}{\_\_STATIC\_INLINE}} \textcolor{keywordtype}{void} \mbox{\hyperlink{mpu__armv8_8h_a01fa1151c9ec0ba5de76f908c0999316}{ARM\_MPU\_ClrRegionEx}}(MPU\_Type* mpu, uint32\_t rnr)}
\DoxyCodeLine{220 \{}
\DoxyCodeLine{221   mpu-\/>RNR = rnr;}
\DoxyCodeLine{222   mpu-\/>RLAR = 0U;}
\DoxyCodeLine{223 \}}
\DoxyCodeLine{224 }
\DoxyCodeLine{228 \mbox{\hyperlink{cmsis__armcc_8h_aba87361bfad2ae52cfe2f40c1a1dbf9c}{\_\_STATIC\_INLINE}} \textcolor{keywordtype}{void} \mbox{\hyperlink{mpu__armv8_8h_a9dcb0afddf4ac351f33f3c7a5169c62c}{ARM\_MPU\_ClrRegion}}(uint32\_t rnr)}
\DoxyCodeLine{229 \{}
\DoxyCodeLine{230   \mbox{\hyperlink{mpu__armv8_8h_a01fa1151c9ec0ba5de76f908c0999316}{ARM\_MPU\_ClrRegionEx}}(MPU, rnr);}
\DoxyCodeLine{231 \}}
\DoxyCodeLine{232 }
\DoxyCodeLine{233 \textcolor{preprocessor}{\#ifdef MPU\_NS}}
\DoxyCodeLine{237 \mbox{\hyperlink{cmsis__armcc_8h_aba87361bfad2ae52cfe2f40c1a1dbf9c}{\_\_STATIC\_INLINE}} \textcolor{keywordtype}{void} ARM\_MPU\_ClrRegion\_NS(uint32\_t rnr)}
\DoxyCodeLine{238 \{  }
\DoxyCodeLine{239   \mbox{\hyperlink{mpu__armv8_8h_a01fa1151c9ec0ba5de76f908c0999316}{ARM\_MPU\_ClrRegionEx}}(MPU\_NS, rnr);}
\DoxyCodeLine{240 \}}
\DoxyCodeLine{241 \textcolor{preprocessor}{\#endif}}
\DoxyCodeLine{242 }
\DoxyCodeLine{249 \mbox{\hyperlink{cmsis__armcc_8h_aba87361bfad2ae52cfe2f40c1a1dbf9c}{\_\_STATIC\_INLINE}} \textcolor{keywordtype}{void} \mbox{\hyperlink{mpu__armv8_8h_a3d50ba8546252bea959e45c8fdf16993}{ARM\_MPU\_SetRegionEx}}(MPU\_Type* mpu, uint32\_t rnr, uint32\_t rbar, uint32\_t rlar)}
\DoxyCodeLine{250 \{}
...
\DoxyCodeLine{254 \}}
\DoxyCodeLine{255 }
\DoxyCodeLine{261 \mbox{\hyperlink{cmsis__armcc_8h_aba87361bfad2ae52cfe2f40c1a1dbf9c}{\_\_STATIC\_INLINE}} \textcolor{keywordtype}{void} \mbox{\hyperlink{mpu__armv8_8h_a6d7f220015c070c0e469948c1775ee3d}{ARM\_MPU\_SetRegion}}(uint32\_t rnr, uint32\_t rbar, uint32\_t rlar)}
\DoxyCodeLine{262 \{}
\DoxyCodeLine{263   \mbox{\hyperlink{mpu__armv8_8h_a3d50ba8546252bea959e45c8fdf16993}{ARM\_MPU\_SetRegionEx}}(MPU, rnr, rbar, rlar);}
\DoxyCodeLine{264 \}}
\DoxyCodeLine{265 }
\DoxyCodeLine{266 \textcolor{preprocessor}{\#ifdef MPU\_NS}}
\DoxyCodeLine{272 \mbox{\hyperlink{cmsis__armcc_8h_aba87361bfad2ae52cfe2f40c1a1dbf9c}{\_\_STATIC\_INLINE}} \textcolor{keywordtype}{void} ARM\_MPU\_SetRegion\_NS(uint32\_t rnr, uint32\_t rbar, uint32\_t rlar)}
\DoxyCodeLine{273 \{}
\DoxyCodeLine{274   \mbox{\hyperlink{mpu__armv8_8h_a3d50ba8546252bea959e45c8fdf16993}{ARM\_MPU\_SetRegionEx}}(MPU\_NS, rnr, rbar, rlar);  }
\DoxyCodeLine{275 \}}
\DoxyCodeLine{276 \textcolor{preprocessor}{\#endif}}
\DoxyCodeLine{277 }
\DoxyCodeLine{283 \mbox{\hyperlink{cmsis__armcc_8h_aba87361bfad2ae52cfe2f40c1a1dbf9c}{\_\_STATIC\_INLINE}} \textcolor{keywordtype}{void} \mbox{\hyperlink{mpu__armv8_8h_ac1a949403bf84eecaf407003fb553ae7}{ARM\_MPU\_OrderedMemcpy}}(\textcolor{keyword}{volatile} uint32\_t* dst, \textcolor{keyword}{const} uint32\_t* \mbox{\hyperlink{cmsis__armcc_8h_a378ac21329d33f561f90265eef89f564}{\_\_RESTRICT}} src, uint32\_t len)}
\DoxyCodeLine{284 \{}
...
\DoxyCodeLine{303     \mbox{\hyperlink{mpu__armv8_8h_ac1a949403bf84eecaf407003fb553ae7}{ARM\_MPU\_OrderedMemcpy}}(\&(mpu-\/>RBAR), \&(table-\/>\mbox{\hyperlink{struct_a_r_m___m_p_u___region__t_afe7a7721aa08988d915670efa432cdd2}{RBAR}}), rowWordSize);}
...
\DoxyCodeLine{311       \mbox{\hyperlink{mpu__armv8_8h_ac1a949403bf84eecaf407003fb553ae7}{ARM\_MPU\_OrderedMemcpy}}(\&(mpu-\/>RBAR)+(rnrOffset*2U), \&(table-\/>\mbox{\hyperlink{struct_a_r_m___m_p_u___region__t_afe7a7721aa08988d915670efa432cdd2}{RBAR}}), c*rowWordSize);}
...
\DoxyCodeLine{317     \}}
\DoxyCodeLine{318     }
\DoxyCodeLine{319     \mbox{\hyperlink{mpu__armv8_8h_ac1a949403bf84eecaf407003fb553ae7}{ARM\_MPU\_OrderedMemcpy}}(\&(mpu-\/>RBAR)+(rnrOffset*2U), \&(table-\/>\mbox{\hyperlink{struct_a_r_m___m_p_u___region__t_afe7a7721aa08988d915670efa432cdd2}{RBAR}}), cnt*rowWordSize);}
\DoxyCodeLine{320   \}}
\DoxyCodeLine{321 \}}
\DoxyCodeLine{322 }
\DoxyCodeLine{328 \mbox{\hyperlink{cmsis__armcc_8h_aba87361bfad2ae52cfe2f40c1a1dbf9c}{\_\_STATIC\_INLINE}} \textcolor{keywordtype}{void} \mbox{\hyperlink{mpu__armv8_8h_aca76614e3091c7324aa9d60e634621bf}{ARM\_MPU\_Load}}(uint32\_t rnr, \mbox{\hyperlink{struct_a_r_m___m_p_u___region__t}{ARM\_MPU\_Region\_t}} \textcolor{keyword}{const}* table, uint32\_t cnt) }
\DoxyCodeLine{329 \{}
\DoxyCodeLine{330   \mbox{\hyperlink{mpu__armv8_8h_ab6094419f2abd678f1f3b121cd115049}{ARM\_MPU\_LoadEx}}(MPU, rnr, table, cnt);}
\DoxyCodeLine{331 \}}
\DoxyCodeLine{332 }
\DoxyCodeLine{333 \textcolor{preprocessor}{\#ifdef MPU\_NS}}
\DoxyCodeLine{339 \mbox{\hyperlink{cmsis__armcc_8h_aba87361bfad2ae52cfe2f40c1a1dbf9c}{\_\_STATIC\_INLINE}} \textcolor{keywordtype}{void} ARM\_MPU\_Load\_NS(uint32\_t rnr, \mbox{\hyperlink{struct_a_r_m___m_p_u___region__t}{ARM\_MPU\_Region\_t}} \textcolor{keyword}{const}* table, uint32\_t cnt) }
\DoxyCodeLine{340 \{}
\DoxyCodeLine{341   \mbox{\hyperlink{mpu__armv8_8h_ab6094419f2abd678f1f3b121cd115049}{ARM\_MPU\_LoadEx}}(MPU\_NS, rnr, table, cnt);}
\DoxyCodeLine{342 \}}
